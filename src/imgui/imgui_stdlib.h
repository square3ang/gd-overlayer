...
// which also demonstrated in 'Dear ImGui Demo->Widgets->Text Input->Resize
// Callback'.
...
//   #include "misc/cpp/imgui_stdlib.cpp" // <-- If you want to include
//   implementation without messing with your project/build.
//   [...]
